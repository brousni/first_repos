...
#define     OWI_DELAY_A_STD_MODE    ((2  * CPU_FREQUENCY))// - OWI_DELAY_OFFSET_CYCLES)
...
#define     OWI_DELAY_E_STD_MODE    ((4   * CPU_FREQUENCY) )//- OWI_DELAY_OFFSET_CYCLES)
